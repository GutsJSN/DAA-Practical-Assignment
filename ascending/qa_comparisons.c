...
int main() {
    // Open output files
    FILE *time_file = fopen("sorting_results_ascending.txt", "w");
    FILE *comp_file = fopen("sorting_comparisons_ascending.txt", "w");
    FILE *efficiency_file = fopen("sorting_efficiency_ascending.txt", "w");
    ...
    printf("Results have been saved to sorting_results_ascending.txt, sorting_comparisons_ascending.txt, and sorting_efficiency_ascending.txt\n");
    return 0;
}
