...
int main() {
    // Open output files
    FILE *time_file = fopen("sorting_results_random.txt", "w");
    FILE *comp_file = fopen("sorting_comparisons_random.txt", "w");
    FILE *efficiency_file = fopen("sorting_efficiency_random.txt", "w");
    ...
    printf("Results have been saved to sorting_results_random.txt, sorting_comparisons_random.txt, and sorting_efficiency_random.txt\n");
    return 0;
}
