...
int main() {
    // Open output file
    FILE *file = fopen("sorting_results_descending.txt", "w");
    if (file == NULL) {
    ...
    for (int n = 1000; n <= 10000; n += 1000) {
        ...
        // Generate descending array instead of ascending
    ...
    printf("Results have been saved to sorting_results_descending.txt\n");
    return 0;
}